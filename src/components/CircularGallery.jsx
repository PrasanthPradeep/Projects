...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `/src/assets/prismbrowser_web.png`, text: 'Prism Browser Website', description: 'An optimized official Webpage of Prism AI Browser', link: 'https://prismbrowser.tech' },
