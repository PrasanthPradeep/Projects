          ...
          <div className="flex items-center justify-center gap-2 sm:gap-4 pointer-events-auto">
            ...
            {currentItem.link && (
              <a
                ...
                className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-zinc-950 text-white rounded-full flex items-center justify-center hover:bg-zinc-800 transition-colors shadow-lg border border-white/20"
                onClick={(e) => e.stopPropagation()}
                title="View Project"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#ffffff" className="sm:w-6 sm:h-6">
